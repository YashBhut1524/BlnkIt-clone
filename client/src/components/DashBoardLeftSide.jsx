    ...
    return (
        <div className="bg-white top-0">
            ...
            <Link to={"/dashboard/profile"}>
                <div className="text-[#666666] py-3 flex items-center space-x-4 hover:text-black transition duration-200 hover:bg-gray-200 border-gray-300 border-b px-2">
            ...
            <div>
                        ...
                        && (
                            <>
                                <Link 
                                    ...
                                    className="text-[#666666] py-3 flex items-center space-x-4 hover:text-black transition duration-200 hover:bg-gray-200 border-gray-300 border-b px-2"
                                >
                ...
                <button 
                    className="text-[#666666] py-3 flex items-center space-x-4 hover:text-black transition duration-200 hover:bg-gray-200 border-gray-300 border-b px-2 w-full"
