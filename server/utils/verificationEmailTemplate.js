    ...
    return `
        <div style="font-family: 'Arial', sans-serif; max-width: 600px; margin: auto; padding: 15px; border-radius: 12px; background: #F8CB46; box-shadow: 0px 4px 15px rgba(0, 0, 0, 0.1); color: #333;">
            ...
            <div style="text-align: center; padding: 10px;">
                <h1 style="color: #333; font-size: 24px; margin: 0;">Welcome to BlinkIt_Clone!</h1>
                <p style="font-size: 14px; color: #555;">Your trusted delivery partner.</p>
                <img 
                    src="https://i.imgur.com/YuofUu6.png" 
